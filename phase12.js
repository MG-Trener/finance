// Phase 12 - tooltips, draggable date ribbon and overview current-date header.
(function(){
  ...
  const tips={
    logout:'Выйти из семейной казны',
    allOperations:'Открыть полный журнал операций',
    createInvite:'Создать персональную ссылку для супруги',
  ...
  function schedule(){
    ...
    requestAnimationFrame(()=>{queued=false;initDateDrag();decorateTooltips()});
  }
